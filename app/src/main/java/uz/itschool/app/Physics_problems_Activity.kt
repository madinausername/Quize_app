...
class Physics_problems_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionList=setData_Physics_problems.getQuestion()
        setQuestion()

        Name=intent.getStringExtra(setData_Physics_problems.name)
            ...
            if(selectedOption!=0){
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        intent.putExtra(setData_Physics_problems.name, Name.toString())
                        intent.putExtra(setData_Physics_problems.score, score.toString())
